            ...
            <div className="flex flex-col w-full px-3 mb-5">
                ...
                <div className="border-white text-left text-sm space-y-6 mb-4">
                    <div className="relative">
                        ...
                        <label for="username" className="absolute left-1 -top-3.5 text-xs text-gray-100 font-light transition-all
                    ...
                    <div className="relative">
                        ...
                        <hr className="shadow-white"></hr>
                        <label for="password" className="absolute left-1 -top-3.5 text-xs text-gray-100 font-light transition-all
                                peer-placeholder-shown:text-sm
                                peer-placeholder-shown:text-gray-300
                                peer-placeholder-shown:top-2
                                peer-focus:-top-3.5
