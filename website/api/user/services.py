...
def get_user_net_worth(user: UserProfile) -> int:
    ...
    """
    from ..entity.selectors import get_entity_income, get_user_entities_by_username

    player_entities = list(get_user_entities_by_username(user.user.username).values_list("entity", "quantity"))

    net_worth = 0
    for entity, quantity in player_entities:
        net_worth += get_entity_income(entity) * quantity
